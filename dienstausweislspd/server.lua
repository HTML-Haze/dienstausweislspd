...
-- Open ID card
RegisterServerEvent('gxmp_dienstausweislspd:open')
AddEventHandler('gxmp_dienstausweislspd:open', function(ID, targetID, type)
		...
		if (user[1] ~= nil) then
			...
			function (licenses)
				...
				if show then
					...
					TriggerClientEvent('gxmp_dienstausweislspd:open', _source, array, type)
				else
